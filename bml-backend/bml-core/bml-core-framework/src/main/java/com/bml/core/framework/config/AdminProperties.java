 ...
 * 管理员的账号和密码通过 {@code application.yml} 配置，支持环境变量覆盖。
 * </p>
 *
 * <h3>配置示例：</h3>
 * <pre>
 ...
 * BML_ADMIN_NICKNAME=管理员         # 用户名（显示名称）
...
public class AdminProperties {
    ...
    /**
     * 管理员显示用户名（必须在 application.yml 中配置）
     */
